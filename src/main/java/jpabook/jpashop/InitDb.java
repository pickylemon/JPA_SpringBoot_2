...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            OrderItem orderItem3 = OrderItem.createOrderItem(book1, 20000, 2);
            OrderItem orderItem4 = OrderItem.createOrderItem(book2, 40000, 2);
            Delivery delivery2 = new Delivery();
            delivery2.setAddress(member1.getAddress());
            Order order2 = Order.createOrder(member1, delivery2, orderItem3, orderItem4);
            em.persist(order2);
        ...
        public void dbInit2() {
            ...
            Book book1 = createSampleBook("SpringBook1",20000 , 200);
            em.persist(book1);

            Book book2 = createSampleBook("SpringBook2",40000, 300);
            em.persist(book2);
            ...
            Order order1 = Order.createOrder(member2, delivery2, orderItem1, orderItem2);
            em.persist(order1);
